...
function LimitedTextInput({characterLimit = 20}) {
    ...
    const handleSubmit = (e) => {
        ...
        alert(limitExceeded ? 'The input exceeds the character limit. Please shorten your text.' : 'Thanks for your submission')
    };
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div>
                ...
                <span
                    className={limitExceeded ? "error" : "no-error"}>Characters remaining: {remainingCharacters} TODO</span>
            </div>
            <input
                type="text"
